...
class RIGIFYFORMBLAB_OT_addrig(bpy.types.Operator):
    ...
    def set_collections(self, meta_rig):
        # db was moved into variables file, changed add_rig.py to create
        # bone collection while generate assigns colors
    ...
    def execute(self, context):
        ...
        if is_ik_rig:
            ...
            meta_rig.data.collections[0] = True
            meta_rig.data.collections[1] = True
            meta_rig.data.collections[2] = True
            ...
            bpy.ops.armature.bone_collections(collections=(True, False, False, False, False, False, False, False, False, False, False, False, False, False,
                                                 False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False, False))
            meta_rig.data.collections[1] = False
            meta_rig.data.collections[2] = False
